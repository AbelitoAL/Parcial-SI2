<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" novalidate>
        ...
        <div class="mt-4">
            ...
            <select name="genero" id="genero" class="block mt-1 w-full dark:border-gray-700 dark:bg-gray-300 dark:text-black focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
